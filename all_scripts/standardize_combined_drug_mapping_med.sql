...
select distinct a.drug_product_id, a.standard_concept_id, a.lookup_value  -- modified the line to add the drug names so i can download directly this one (cristiano 17-03-20)
