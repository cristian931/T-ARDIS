"""This Function merge the different obtained file from the FAERS cleaning procedure. It merge and associate the drug
to the respective side effect in a pairwise way, moreover obtain a new column containing the FAERS and ISR codes,
remove unmapped entities and capitalize the side effect names"""
...
def cleaner(drug_file, legacy_reac, current_reac):
    ...
    drug_all_no_pt_na['FAERS_ID'] = drug_all_no_pt_na['primaryid'].fillna(drug_all_no_pt_na['isr'])
