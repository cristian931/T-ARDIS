...
select distinct a.primaryid, a.isr, a.drug_seq, a.role_cod, a.standard_concept_id, a.lookup_value  -- modified the line to add the drug names so i can download directly this one (cristiano 17-03-20)
